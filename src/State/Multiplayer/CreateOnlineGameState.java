        ...
        continueGameBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(!validInput) {
                    ...
                    try {
                        /* Server starten */
                        //GamePanel.server = new Server();

                        Socket socket = new Socket(ipAdressInput, portInput);
                        System.out.println("Du hast dich mit " + ipAdressInput + " verbunden.");

                        //Client client = new Client(socket);

                        PrintWriter outputStream = new PrintWriter(socket.getOutputStream());
                        outputStream.println(nameInputAsString);
                        outputStream.flush();
