...
//        }
    ...
    public void checkRecipes() {
        if(productBench[0].equals("null")) {
            // Gold herstellen
            if(craftBench[0].equals("Erde") && craftBench[1].equals("Gras") && craftBench[2].equals("null") && craftBench[3].equals("null")) {  // Für alle also bis craftBench[8].equals("null")
                ...
                if(!holdingName.equals("Gold")) {   // Die klappen noch nicht ganz, kleiner Fehler
