...
public class TileMap {
    ...
    private BufferedImage dirtTileTexture;
    ...
    public void loadMap() {
        ...
        try {
            ...
            while (scanner.hasNextLine()) {
                ...
                numberInRow = line.split("[,]");
                //tileType = Integer.parseInt(scanner.next());
                //tileXPos = Integer.parseInt(scanner.next());
                //tileYPos = Integer.parseInt(scanner.next());

                for(String number : numberInRow) {
                    try {
                        switch (Integer.parseInt(number)) {
                            case 0:
                                break;
                            case Tile.WATERTILE_TOP:
                                tiles.add(new WaterTile(waterTileTop, counterX, counterY, true, false, false));
                                break;
                            case Tile.WATERTILE:
                                tiles.add(new WaterTile(waterTile, counterX, counterY, true, false, false));
                                break;
                            case Tile.LAVALTILETOP:
                                tiles.add(new LavaTile(lavaTileTop, counterX, counterY, true, false, false));
                                break;
                            case Tile.LAVATILE:
                                tiles.add(new LavaTile(lavaTile, counterX, counterY, true, false, false));
                                break;
                            case Tile.GRASTILE_RIGHT:
                                tiles.add(new GrasTile(grasTileRight, counterX, counterY, true, true, true));
                                break;
                            case Tile.GRASTILE_LEFT:
                                tiles.add(new GrasTile(grasTileLeft, counterX, counterY, true, true, true));
                                break;
                            case Tile.GRASTILE_BOTTOM:
                                tiles.add(new GrasTile(grasTileBottom, counterX, counterY, true, true, true));
                                break;
                            case Tile.GRASTILE_BOTTOMRIGHTCORNER:
                                tiles.add(new GrasTile(grasTileBottomRightCorner, counterX, counterY, true, true, true));
                                break;
                            case Tile.GRASTILE_BOTTOMLEFTCORNER:
                                tiles.add(new GrasTile(grasTileBottomLeftCorner, counterX, counterY, true, true, true));
                                break;
                            case Tile.GRASTILE_TOPRIGHTCORNER:
                                tiles.add(new GrasTile(grasTileTopRightCorner, counterX, counterY, true, true, true));
                                break;
                            case Tile.GRASTILE_TOPLEFTCORNER:
                                tiles.add(new GrasTile(grasTileTopLeftCorner, counterX, counterY, true, true, true));
                                break;
                            case Tile.GRASTILE:
                                tiles.add(new GrasTile(grasTile, counterX, counterY, true, true, true));
                                break;
                            case Tile.DIRTDARK:
                                tiles.add(new DirtTile(dirtDark, counterX, counterY, true, true, true));
                                break;
                            case Tile.DIRTMIDDARK:
                                tiles.add(new DirtTile(dirtMidDark, counterX, counterY, true, true, true));
                                break;
                            case Tile.DIRT:
                                tiles.add(new DirtTile(dirt, counterX, counterY, true, true, true));
                                break;
                            case Tile.STONEWHITE1:
                                tiles.add(new StoneTile(stoneWhite1, counterX, counterY, true, true, true));
                                break;
                            case Tile.STONEWHITE2:
                                tiles.add(new StoneTile(stoneWhite2, counterX, counterY, true, true, true));
                                break;
                            case Tile.STONEWHITE3:
                                tiles.add(new StoneTile(stoneWhite3, counterX, counterY, true, true, true));
                                break;
                            case Tile.STONEWHITELEAF:
                                tiles.add(new StoneTile(stoneWhiteLeafs, counterX, counterY, true, true, true));
                                break;
                            case Tile.STONERED1:
                                tiles.add(new StoneTile(stoneRed1, counterX, counterY, true, true, true));
                                break;
                            case Tile.STONERED2:
                                tiles.add(new StoneTile(stoneRed2, counterX, counterY, true, true, true));
                                break;
                            case Tile.STONERED3:
                                tiles.add(new StoneTile(stoneRed3, counterX, counterY, true, true, true));
                                break;
                            case Tile.STONEREDLEAF:
                                tiles.add(new StoneTile(stoneRedLeafs, counterX, counterY, true, true, true));
                                break;
                            case Tile.COPPER:
                                tiles.add(new CopperTile(copper, counterX, counterY, true, true, true));
                                break;
                            case Tile.SILVER:
                                tiles.add(new SilverTile(silver, counterX, counterY, true, true, true));
                                break;
                            case Tile.GOLD:
                                tiles.add(new GoldTile(gold, counterX, counterY, true, true, true));
                                break;
                            case Tile.LEAFBOTTOM_LEFTCORNER:
                                tiles.add(new LeafTile(leafBottomLeftCorner, counterX, counterY, true, true, true));
                                break;
                            case Tile.LEAFBOTTOM:
                                tiles.add(new LeafTile(leafBottom, counterX, counterY, true, true, true));
                                break;
                            case Tile.LEAFBOTTOM_RIGHTCORNER:
                                tiles.add(new LeafTile(leafBottomRightCorner, counterX, counterY, true, true, true));
                                break;
                            case Tile.LEAFRIGHT:
                                tiles.add(new LeafTile(leafRight, counterX, counterY, true, true, true));
                                break;
                            case Tile.LEAFNORMAL:
                                tiles.add(new LeafTile(leafNormal, counterX, counterY, true, true, true));
                                break;
                            case Tile.LEAFLEFT:
                                tiles.add(new LeafTile(leafLeft, counterX, counterY, true, true, true));
                                break;
                            case Tile.LEAFTOP_LEFTCORNER:
                                tiles.add(new LeafTile(leafTopLeftCorner, counterX, counterY, true, true, true));
                                break;
                            case Tile.LEAFTOP:
                                tiles.add(new LeafTile(leafTop, counterX, counterY, true, true, true));
                                break;
                            case Tile.LEAFTOP_RIGHTCORNER:
                                tiles.add(new LeafTile(leafTopRightCorner, counterX, counterY, true, true, true));
                                break;
                            case Tile.TREETRUNK_ROOTLEFT:
                                tiles.add(new WoodTile(treeTrunkRootLeft, counterX, counterY, true, true, true));
                                break;
                            case Tile.TREETRUNK_BOTTOMLEFT:
                                tiles.add(new WoodTile(treeTrunkBottomLeft, counterX, counterY, true, true, true));
                                break;
                            case Tile.TREETRUNK_BOTTOMRIGHT:
                                tiles.add(new WoodTile(treeTrunkBottomRight, counterX, counterY, true, true, true));
                                break;
                            case Tile.TREETRUNK_ROOTRIGHT:
                                tiles.add(new WoodTile(treeTrunkRootRight, counterX, counterY, true, true, true));
                                break;
                            case Tile.TREETRUNK_ROUNDEDCORNER_TOPLEFT:
                                tiles.add(new WoodTile(treeTrunkRoundedCornerTopLeft, counterX, counterY, true, true, true));
                                break;
                            case Tile.TREETRUNK_NEXTTOCORNER:
                                tiles.add(new WoodTile(treeTrunkNextToCorner, counterX, counterY, true, true, true));
                                break;
                            case Tile.TREETRUNK_HORIZONTALNORMAL:
                                tiles.add(new WoodTile(treeTrunkHorizontalNormal, counterX, counterY, true, true, true));
                                break;
                            case Tile.TREETRUNK_ROUNDEDCORNER_BOTTOMRIGHT:
                                tiles.add(new WoodTile(treeTrunkRoundedCornerBottomRight, counterX, counterY, true, true, true));
                                break;
                            case Tile.TREETRUNK_VERTICALNORMAL:
                                tiles.add(new WoodTile(treeTrunkVerticalNormal, counterX, counterY, true, true, true));
                                break;
                            case Tile.TREETRUNK_TOPCENTER:
                                tiles.add(new WoodTile(treeTrunkTopCenter, counterX, counterY, true, true, true));
                                break;
                            case Tile.TREETRUNK_TOPLEFT:
                                tiles.add(new WoodTile(treeTrunkTopLeft, counterX, counterY, true, true, true));
                                break;
                            case Tile.TREETRUNK_TOPLEFTEND:
                                tiles.add(new WoodTile(treeTrunkTopLeftEnd, counterX, counterY, true, true, true));
                                break;
                            case Tile.TREETRUNK_TOPRIGHTEND:
                                tiles.add(new WoodTile(treeTrunkTopRightEnd, counterX, counterY, true, true, true));
                                break;
                            default:
                                tiles.add(new DirtTile(dirtTileTexture, counterX, counterY, true, true, true));
                                break;
                        }
                        counterX += Tile.WIDTH;
                    }
